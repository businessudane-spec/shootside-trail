      ...
      >
        <motion.div
          ...
          className={`relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-[#0d0d0d] ${
            isInstagram ? "w-full max-w-sm" : "w-full max-w-5xl"
          }`}
        >
          <button
            onClick={onClose}
            className="absolute top-3 right-3 z-20 w-9 h-9 flex items-center justify-center rounded-full bg-black/70 text-white border border-white/20 hover:bg-[#ad46ff] transition animate-none"
          >
            ✕
          </button>
    ...
    <>
      ...
      <main className="bg-black text-white min-h-screen">
        ...
        <section
          ...
          className="relative pt-36 pb-24 px-6 md:px-12 overflow-hidden"
        >
